  ...
  return (
    <html lang="es">
      <head>
        ...
        <script dangerouslySetInnerHTML={{ __html: `window.__WIDGET_API_URL="https://automatizacion-webs.vercel.app";window.__PROJECT_ID="nucleo-fisioterapia";` }} />

        <script
          src="https://automatizacion-webs.vercel.app/widget.js"
          data-project-name="Núcleo Fisioterapia"
          data-api-url="https://automatizacion-webs.vercel.app"
          data-project-id="nucleo-fisioterapia"
          data-primary-color="#fff400"
          defer
        ></script>
      </head>
